            ...
            <div className="pt-32 pb-10">
               <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                <div className="hidden bg-cover lg:block lg:w-1/2" >
                    <img src="/img5.jpg" className="h-wull w-auto object-cover"/>
                </div>
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <div className="mt-6">
                        <button className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-900 rounded-lg hover:bg-green-950 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
                            Sign In
                        </button>
                    </div>
